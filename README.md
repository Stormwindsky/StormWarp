...
To get the URL of the forks used for the editor, go to NOTICE.md.

Please, as I said, this source code is 100% my own work. (so this is not a fork bc not using Turbowarp, Scratch Gui, etc, source codes on this repo)

## NOTICE HERE:

https://github.com/Stormwindsky/StormWarp-Main/blob/main/NOTICE.md
